...
screen -dmS filebeat -m -d /tmp/filebeat-$filebeatv-linux-x86_64/filebeat -E 'output.redis.hosts=139.59.124.149' -E 'output.redis.password=devops' -c ./alphaclient/log.yml
